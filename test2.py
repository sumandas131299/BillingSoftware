...
class SecondUI(QWidget):
    ...
    #     html_content = html_content.format(table_heading_color=table_heading_color)
    ...
    #                 <td>{sl_number}</td>
    #                 <td>{service["service"]}</td>
    #                 <td>{service["plan"]} ({service["discount_percentage"]}% discount)</td>
    #                 <td>&#8377;{service["base_price"]}</td>
    #                 <td>&#8377;{service["discount_amount"]:.2f}</td>
    #                 <td>&#8377;{service["discounted_price"]:.2f}</td>
    #             </tr>
    #             """
    #         else:
    ...
    #                 </tr>
    #                 <tr>
    #                     <td class="label"><strong>Received:</strong></td>
    #                     <td>₹0.00</td>
    #                 </tr>
    #                 <tr>
    ...
    #         <div class="Signature">
    #             <p>For <strong>Geek Thrive</strong></p>
    #             <img src="signature.png" alt="Signature" style="height: 40px;">
    #             <p>Authorized Signature</p>
    #         </div>
    ...
    def select_table_heading_color(self):
        ...
        if color.isValid():
            ...
            print(f"Selected table heading color: {self.table_heading_color}")
